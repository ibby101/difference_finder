...
public:
	...
	static void parallelDiff(const std::vector<uint16_t>& imageA, const std::vector<uint16_t>& imageB, const size_t startIndex, const size_t count, const std::vector<uint16_t>& outputVector);
};
